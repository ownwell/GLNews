 ...
 * <p/>
 * <b>Important: </b> Call {@link Crouton#clearCroutonsForActivity(android.app.Activity)}
...
public final class Crouton {
     ...
     *
     * @param activity The {@link android.app.Activity} that the {@link Crouton} should be
     *            attached to.
     ...
     * @param text The text you want to display.
     * @param style The style that this {@link Crouton} should be created with.
     * @param viewGroup The {@link android.view.ViewGroup} that this {@link Crouton} should
     *            be added to.
     */
